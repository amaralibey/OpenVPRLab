...
def update_config_yaml(dataset_name: str, dataset_type: str, dataset_path: str) -> None:
    """Update the config/data/config.yaml file with the path of the downloaded dataset."""
    config_path = Path(__file__).parent.parent / "config/data/config.yaml" # Assuming the config file is in the project root
    ...
    console.print(f"Updated config/data/config.yaml with path for {dataset_name}", style="bold green")
